...
const SKILL_DESC_CN: Record<string, string> = {
  'browse': '无头浏览器浏览，用于测试网站和截图',
  'ship': '发布流程：检测分支、运行测试、创建 PR',
  'review': 'PR 预发布评审，检查代码安全和结构问题',
  'qa': '系统化 QA 测试并修复发现的 bug',
  'qa-only': 'QA 测试报告模式，只报告不修复',
  'design-review': '设计评审：检查视觉一致性、间距问题',
  'design-html': '生成生产级 HTML/CSS 设计',
  'design-shotgun': '生成多个设计变体并对比',
  'design-consultation': '设计咨询：创建设计系统',
  'investigate': '系统化调试，根因分析',
  'cso': '安全审计：基础设施、供应链、OWASP',
  'benchmark': '性能回归检测',
  'canary': '发布后监控：检查错误和性能',
  'health': '代码质量仪表板',
  'office-hours': 'YC Office Hours 模式咨询',
  'plan-ceo-review': 'CEO 模式计划评审',
  'plan-eng-review': '工程经理模式计划评审',
  'plan-design-review': '设计师模式计划评审',
  ...
  'open-gstack-browser': '启动 AI 控制的浏览器',
  'pair-agent': '配对远程 AI 代理'
};
